    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            buildingElements.forEach(building => {
                ...
                tooltip.className = 'absolute bottom-full left-1/2 transform -translate-x-1/2 -mb-2 bg-gray-700 text-white text-xs px-2 py-1 rounded-md opacity-0 transition-opacity duration-200 pointer-events-none';
                tooltip.textContent = building.dataset.name;
                building.style.position = 'relative'; // Ensure the building is a positioned element
                building.appendChild(tooltip);
